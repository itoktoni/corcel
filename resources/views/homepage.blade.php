...
<body class="light-scheme">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="de-flex">
                        ...
                        <div class="de-flex-col">
                            <div class="de-flex-col header-col-mid">
                                <ul id="mainmenu">
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden soft-shadow">
                                                                    <a class="p-0" href="index.html">
                                                                        <img src="{{ asset('frontend/images/demo/homepage-1.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Gym 1</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden soft-shadow">
                                                                    <a class="p-0" href="homepage-2.html">
                                                                        <img src="{{ asset('frontend/images/demo/homepage-2.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Gym 2</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden soft-shadow">
                                                                    <a class="p-0" href="homepage-3.html">
                                                                        <img src="{{ asset('frontend/images/demo/homepage-3.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Gym 3</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden soft-shadow">
                                                                    <a class="p-0" href="homepage-4.html">
                                                                        <img src="{{ asset('frontend/images/demo/homepage-4.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Gym 4</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden shadow-soft">
                                                                    <a class="p-0" href="02_homepage-1.html">
                                                                        <img src="{{ asset('frontend/images_02/demo/homepage-1.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Yoga 1</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden shadow-soft">
                                                                    <a class="p-0" href="02_homepage-2.html">
                                                                        <img src="{{ asset('frontend/images_02/demo/homepage-2.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Yoga 2</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden shadow-soft">
                                                                    <a class="p-0" href="02_homepage-3.html">
                                                                        <img src="{{ asset('frontend/images_02/demo/homepage-3.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Yoga 3</h6>
                                                            </div>

                                                            <div class="col-lg-3 col-md-4 col-sm-6 text-center">
                                                                <div class="relative hover text-center overflow-hidden shadow-soft">
                                                                    <a class="p-0" href="02_homepage-4.html">
                                                                        <img src="{{ asset('frontend/images_02/demo/homepage-4.webp') }}" class="w-100 relative hover-scale-1-1" alt="">
                                                                    </a>
                                                                </div>
                                                                <h6 class="mt-3">Homepage Yoga 4</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li><a class="menu-item" href="schedule.html">Schedule</a></li>
                                    <li><a class="menu-item" href="classes.html">Classes</a>
                                        <ul>
                                            <li><a class="menu-item" href="classes.html">Classes Style 1</a></li>
                                            <li><a class="menu-item" href="classes-2.html">Classes Style 2</a></li>
                                            <li><a class="menu-item" href="class-single.html">Class Single</a>
                                        </ul>
                                    </li>
                        ...
                        <div class="de-flex-col">
                            <a class="btn-main fx-slide w-100" href="join.html"><span>Join Now</span></a>
    ...
    <main>
        ...
        <section class="text-light relative" data-bgimage="url({{ asset('frontend/images/background/5.jpg') }}) center">
            <div class="container relative z-2">
                <div class="row g-4">
                    <div class="col-xl-6 col-lg-6">
                        <div class="spacer-double"></div>
                        <h1 class="wow fadeInUp" data-wow-delay=".0s">Transform your Body and Mind with PowerFlow</h1>
                        <p class="me-lg-5 mb-4 wow fadeInUp" data-wow-delay=".2s">Discover world-class training, expert coaches, and modern equipment to help you achieve your fitness goals, build strength, burn fat, and stay motivated every single day with our dynamic gym experience.</p>
                        <div class="d-flex align-items-center wow fadeInUp" data-wow-delay=".9s">
                            <a class="btn-main fx-slide me-4 wow fadeInUp" data-wow-delay=".4s" href="join.html"><span>Join Now</span></a>
                            <a class="de-flex align-items-center text-white popup-youtube" href="https://www.youtube.com/watch?v=JxRnueT6wHs">
                                <div class="btn-play sm circle wow scaleIn"><span></span></div>
                                <div class="ms-3 fw-bold">Watch Video</div>
                            </a>
                        </div>
                        <div class="spacer-single"></div>
                        <div class="d-flex align-items-center wow fadeInUp" data-wow-delay=".9s">
                            <div class="relative me-4">
                                <img src="{{ asset('frontend/images/testimonial/1.webp') }}" class="w-50px circle ms-min-10" alt="">
                                <img src="{{ asset('frontend/images/testimonial/2.webp') }}" class="w-50px circle ms-min-10" alt="">
                                <img src="{{ asset('frontend/images/testimonial/3.webp') }}" class="w-50px circle ms-min-10" alt="">
                            </div>
                            <div class="fw-600 fs-14 lh-1-5"><span class="fs-16 fw-bold">2300+</span><br>Active Members</div>
                        </div>
                        <div class="spacer-double"></div>
                    </div>
                </div>
        ...
        <section>
            <div class="container">
              <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="relative">
                        <div class="p-4 mt-3 bg-color text-light abs abs-centered rounded-1 text-center z-2 wow fadeIn" data-wow-delay=".6s">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 wow fadeInRight" data-wow-delay=".2s">
                                <div class="relative rounded-1 overflow-hidden">
                                    <img src="{{ asset('frontend/images/misc/p1.webp') }}" class="w-100" alt="">
                                    <div class="de-overlay-gradient-color h-50 top-50"></div>
                                </div>
                            </div>
                            <div class="col-md-6 wow fadeInRight" data-wow-delay=".4s">
                                <div class="relative rounded-1 overflow-hidden">
                                    <img src="{{ asset('frontend/images/misc/p2.webp') }}" class="w-100" alt="">
                                    <div class="de-overlay-gradient-color h-50 top-50"></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6">
                  <div class="ms-lg-4">
                      <div class="subtitle id-color mb-3 wow fadeInUp" data-wow-delay=".0s">Welcome to PowerFlow</div>
                      <h2 class="wow fadeInUp" data-wow-delay=".2s">Push Beyond Limits And Unlock Your Strength</h2>

                      <p class="wow fadeIn" data-wow-delay=".4s">Step into a fitness experience designed to challenge your body and sharpen your mind. With expert trainers, cutting-edge equipment, and programs built for all levels, you’ll gain the power, confidence, and results you’ve always wanted. Every workout moves you closer to becoming your strongest self.</p>

                      <a class="btn-main fx-slide mb10 mb-3 wow fadeIn" href="join.html"><span>Join Now</span></a>
                  </div>
                </div>
              ...
              <div class="row g-4">
                <div class="col-md-3 col-sm-6 mb-sm-30">
                    <div class="de_count text-center fs-15 wow fadeInRight" data-wow-delay=".0s">
                        <h3 class="fs-48 mb-1"><span class="timer" data-to="12000" data-speed="3000">0</span><span class="id-color">+</span></h3>
                        <div class="fs-15">Training Hours</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-sm-30">
                    <div class="de_count text-center fs-15 wow fadeInRight" data-wow-delay=".2s">
                        <h3 class="fs-48 mb-1"><span class="timer" data-to="2300" data-speed="3000">0</span><span class="id-color">+</span></h3>
                        <div class="fs-15">Active Members</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-sm-30">
                    <div class="de_count text-center fs-15 wow fadeInRight" data-wow-delay=".4s">
                        <h3 class="fs-48 mb-1"><span class="timer" data-to="540" data-speed="3000">0</span><span class="id-color">+</span></h3>
                        <div class="fs-15">Transformations</div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 mb-sm-30">
                    <div class="de_count text-center fs-15 wow fadeInRight" data-wow-delay=".6s">
                        <h3 class="fs-48 mb-1"><span class="timer" data-to="25" data-speed="3000">0</span><span class="id-color">+</span></h3>
                        <div class="fs-15">Certified Trainers</div>
                    </div>
                </div>
              </div>
        ...
        <section class="relative" data-bgimage="url({{ asset('frontend/images/background/6.jpg') }}) center">
                    ...
                    <div class="col-lg-8 text-center">
                        <div class="owl-single-dots owl-carousel owl-theme">
                            ...
                            <div class="item">
                                ...
                                <h3 class="mb-4 wow fadeInUp fs-36 text-white">The trainers pushed me beyond my limits while keeping every workout fun and motivating.</h3>
                                <span class="text-white wow fadeInUp">Anna L., Paris</span>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <h3 class="mb-4 wow fadeInUp fs-36 text-white">I’ve gained strength, lost weight, and found a community that truly inspires me.</h3>
                                <span class="text-white wow fadeInUp">Michael H., Toronto</span>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <h3 class="mb-4 wow fadeInUp fs-36 text-white">The facilities are top-notch. Every session leaves me feeling stronger and more energized.</h3>
                                <span class="text-white wow fadeInUp">Nadia R., Dubai</span>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <h3 class="mb-4 wow fadeInUp fs-36 text-white">Joining this gym completely changed my lifestyle. It’s the best decision I ever made.</h3>
                                <span class="text-white wow fadeInUp">Tom S., Los Angeles</span>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <h3 class="mb-4 wow fadeInUp fs-36 text-white">From the group classes to personal training, everything is professional and motivating.</h3>
                                <span class="text-white wow fadeInUp">Elise K., Amsterdam</span>
                            </div>
                            ...
                            <div class="item">
                                ...
                                <h3 class="mb-4 wow fadeInUp fs-36 text-white">Amazing atmosphere, skilled trainers, and results I never thought possible.</h3>
                                <span class="text-white wow fadeInUp">David M., Singapore</span>
                            </div>
            ...
            <div class="container">
                <div class="row mb-3 g-4 align-items-center justify-content-between">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".2s">
                        ...
                        <h2 class="wow fadeInUp">Classes Designed For You</h2>
                        <p>From personal training and group classes to nutrition guidance and strength coaching, we provide everything you need to achieve lasting fitness results.</p>
                    </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col-5 d-flex flex-column justify-content-between p-40">
                                            <div>
                                                ...
                                                <p class="mb-0 text-wrap">Build power, endurance, and a lean physique with a combination of barbell, dumbbell, and functional training techniques.</p>
                                            </div>
                                            <div>
                                                <a href="class-single.html" class="id-color text-uppercase fw-semibold small text-decoration-none">View Details</a>
                                            </div>
                                        </div>
                                        <div class="col-7 angled-wrapper">
                                            <img src="{{ asset('frontend/images/classes/p1.webp') }}" alt="Strength & Conditioning" class="h-100 w-100 object-cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="relative bg-color text-light rounded-1 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-5 d-flex flex-column justify-content-between p-40">
                                            <div>
                                                <h3 class="fw-bold mb-2">Personal Training</h3>
                                                <p class="mb-0 text-wrap">One-on-one guidance from professional trainers to maximize your results safely and efficiently with tailored programs.</p>
                                            </div>
                                            <div>
                                                <a href="class-single.html" class="id-color text-uppercase fw-semibold small text-decoration-none">View Details</a>
                                            </div>
                                        ...
                                        <div class="col-7 angled-wrapper">
                                            <img src="{{ asset('frontend/images/classes/p2.webp') }}" alt="Personal Training" class="h-100 w-100 object-cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="relative bg-color text-light rounded-1 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-5 d-flex flex-column justify-content-between p-40">
                                            <div>
                                                <h3 class="fw-bold mb-2">HIIT & Group Training</h3>
                                                <p class="mb-0 text-wrap">Join high-energy group workouts like HIIT, spinning, and bootcamps to burn calories, build stamina, and stay motivated.</p>
                                            </div>
                                            <div>
                                                <a href="class-single.html" class="id-color text-uppercase fw-semibold small text-decoration-none">View Details</a>
                                            </div>
                                        ...
                                        <div class="col-7 angled-wrapper">
                                            <img src="{{ asset('frontend/images/classes/p3.webp') }}" alt="HIIT & Group Training" class="h-100 w-100 object-cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="relative bg-color text-light rounded-1 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-5 d-flex flex-column justify-content-between p-40">
                                            <div>
                                                <h3 class="fw-bold mb-2">Yoga & Pilates</h3>
                                                <p class="mb-0 text-wrap">Improve flexibility, reduce stress, and enhance body control with calming yoga and pilates sessions led by certified instructors.</p>
                                            </div>
                                            <div>
                                                <a href="class-single.html" class="id-color text-uppercase fw-semibold small text-decoration-none">View Details</a>
                                            </div>
                                        ...
                                        <div class="col-7 angled-wrapper">
                                            <img src="{{ asset('frontend/images/classes/p4.webp') }}" alt="Yoga & Pilates" class="h-100 w-100 object-cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="relative bg-color text-light rounded-1 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-5 d-flex flex-column justify-content-between p-40">
                                            <div>
                                                <h3 class="fw-bold mb-2">Circuit Training</h3>
                                                <p class="mb-0 text-wrap">Ignite your metabolism with intense circuit training that blends cardio and strength to deliver total-body results fast.</p>
                                            </div>
                                            <div>
                                                <a href="class-single.html" class="id-color text-uppercase fw-semibold small text-decoration-none">View Details</a>
                                            </div>
                                        ...
                                        <div class="col-7 angled-wrapper">
                                            <img src="{{ asset('frontend/images/classes/p5.webp') }}" alt="Circuit Training" class="h-100 w-100 object-cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="item">
                                <div class="relative bg-color text-light rounded-1 overflow-hidden">
                                    <div class="row g-0">
                                        <div class="col-5 d-flex flex-column justify-content-between p-40">
                                            <div>
                                                <h3 class="fw-bold mb-2">Athletic Performance</h3>
                                                <p class="mb-0 text-wrap">Train like an athlete with explosive power drills, balance routines, and mobility work to boost speed and agility.</p>
                                            </div>
                                            <div>
                                                <a href="class-single.html" class="id-color text-uppercase fw-semibold small text-decoration-none">View Details</a>
                                            </div>
                                        ...
                                        <div class="col-7 angled-wrapper">
                                            <img src="{{ asset('frontend/images/classes/p6.webp') }}" alt="Athletic Performance" class="h-100 w-100 object-cover">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row gy-4 justify-content-center">
                    <div class="col-lg-6 text-center wow fadeIn" data-wow-delay=".2s">
                        <div class="uptitle id-color wow fadeInUp">Why Choose Us</div>
                        <h2 class="wow fadeInUp">Build Strength, Endurance, and Confidence with Us</h2>
                    </div>
                </div>
                <div class="row g-4 gx-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="relative">
                            <div class="rounded-1 w-90 overflow-hidden wow zoomIn">
                                <img src="{{ asset('frontend/images/misc/l4.webp') }}" class="w-100 wow scaleIn" alt="Gym Training Session">
                            ...
                            <div class="rounded-1 w-50 abs mb-min-50 end-0 bottom-0 z-2 overflow-hidden shadow-soft wow zoomIn" data-wow-delay=".2s">
                                <img src="{{ asset('frontend/images/misc/s1.webp') }}" class="w-100 wow scaleIn" data-wow-delay=".2s" alt="Personal Coaching Session">
                                <div class="gradient-edge-bottom color abs w-100 h-40 bottom-0"></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="relative mb-4 wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="ps-100">
                                <h4>Certified Personal Trainers</h4>
                                <p>Train with professionals who guide your every move — ensuring proper form, safety, and faster results for your fitness goals.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative mb-4 wow fadeInUp" data-wow-delay=".4s">
                            ...
                            <div class="ps-100">
                                ...
                                <p>Experience cutting-edge machines and functional training tools that make every workout effective, fun, and challenging.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative wow fadeInUp" data-wow-delay=".6s">
                            ...
                            <div class="ps-100">
                                ...
                                <p>Join a supportive community that inspires you to stay consistent, push your limits, and celebrate every milestone along the way.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-4 justify-content-center text-center">
                    <div class="col-lg-6 wow fadeIn" data-wow-delay=".2s">
                        ...
                        <p>Check our weekly schedule to plan your workouts, from morning yoga to evening strength training sessions.</p>
                    </div>
                </div>
        ...
        <section class="bg-color text-light pt-50 pb-50">
            <div class="container">
                <div class="row g-4">
                    <div class="col-md-9">
                        <h3 class="mb-0 fs-32">Ready to take the first step towards your fitness goals?</h3>
                    </div>
                    <div class="col-lg-3 text-lg-end">
                        <a class="btn-main fx-slide btn-line" href="join.html"><span>Join Now</span></a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-4 col-sm-6">
                    <img src="{{ asset('frontend/images/jakartabg.png') }}" class="w-250px" alt="" >
                    <div class="spacer-20"></div>
                    <p>Transform your lifestyle with our expert gym services! From strength training to group classes, we help you achieve your fitness goals with personalized, results-driven programs. Professional, reliable, and passionate</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6">
                            <div class="widget">
                                <h5>Our Services</h5>
                                <ul>
                                    <li><a href="class-single.html">Strength & Conditioning</a></li>
                                    <li><a href="class-single.html">Personal Training</a></li>
                                    <li><a href="class-single.html">HIIT & Group Training</a></li>
                                    <li><a href="class-single.html">Yoga & Pilates</a></li>
                                    <li><a href="class-single.html">Circuit Training</a></li>
                                    <li><a href="class-single.html">Athletic Performance</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 order-lg-2 order-sm-1">
                    <div class="widget">
                        <div class="fw-bold"><i class="icofont-clock-time me-2 id-color"></i>We're Open</div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="de-flex">
                            <div class="de-flex-col">
                                Copyright 2025 - Shared By &nbsp;<a href="" target="_blank">Designer</a>
                            </div>
